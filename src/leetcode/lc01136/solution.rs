...
impl Solution {
    pub fn minimum_semesters(n: i32, relations: Vec<Vec<i32>>) -> i32 {
        ...
        let mut parens = vec![0; (n + 1) as usize];
        ...
        while !queue.is_empty() {
            ...
            for _ in 0..size {
                ...
                let list = map.get(&e).unwrap_or(&default);
                for v in list.into_iter() {
                    parens[*v as usize] -= 1;
                    if parens[*v as usize] == 0 {
                        queue.push(*v);
                        count += 1;
                    }
                }
